It like your `script.js` file is empty, which means the JavaScript code hasn't been saved in the file yet. To ensure your app functions correctly, you need to paste the JavaScript code we wrote earlier into this file. Here's what you should do:

### Steps to Fix the JavaScript File

#### 1. Open `script.js`
- Locate your `script.js` file in your project directory and open it in a text editor.

#### 2. Add the JavaScript Code
- Copy the JavaScript code from below and paste it into the `script.js` file:
